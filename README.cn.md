...
![pwndbg](https://repo.x-cmd.io/pwndbg.svg?lang=zh)
...
合计: **119,112** 行代码（覆盖前 5 种语言、共 **535** 个文件）。
...
- **上游仓库**: <https://github.com/pwndbg/pwndbg>
- **官网**: <https://pwndbg.re/>
- **许可证**: MIT
...
- **Star**: 10,851 · **Fork**: 1,266 · **开放 issue**: 1,358 · **贡献者**: 316

## 累计统计

- **发布数**: 26 · **已合并 PR**: 2353 · **开放 PR**: 24 · **已关闭 issue**: 1156 · **开放 issue**: 202 · **提交数**: 3184

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-11 | 0 | 27 | 11 | 6 | 22 | 66 |
| last60d | 2026-07-12 | 1 | 56 | 16 | 12 | 25 | 97 |
| 90d | 2026-06-12 | 1 | 77 | 19 | 17 | 26 | 133 |
| last180d | 2026-03-14 | 1 | 169 | 19 | 36 | 37 | 245 |
| 360d | 2025-09-15 | 5 | 478 | 22 | 114 | 91 | 566 |
| last720d | 2024-09-20 | 10 | 990 | 24 | 320 | 149 | 1089 |
...
在 [repology.org](https://repology.org/project/pwndbg) 上共有 **32** 个发行版报告此项目。**2** 个 ✅ 已是最新上游版本，**17** 个 ⚠️ 使用旧版本。
...
pwndbg 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `pwndbg` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/pwndbg.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260910.yml` · 2026-09-10T23:33:27Z._
